module voting_addr::voting_system {
    ...
    const SEED: vector<u8> = b"VOTING_SYSTEM_SEED";
    ...
    public entry fun create_election(
        ...
        let resource_addr = account::create_resource_address(&@voting_addr, SEED);
    ...
    public entry fun cast_vote(
        ...
        // Ensure candidate index is valid and election is active
